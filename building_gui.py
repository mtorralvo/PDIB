...
class Application(tkinter.Frame):
    ...
    def create_optional_inputs (self):
        ...
        stoich_frame = Frame(self.optional_inputs_frame, width=390, borderwidth=2)

        self.get_stoichiometry = StringVar(value="A:1 B:2")

        L4 = Label(stoich_frame, text="Enter stoichiometry")
        L4.pack(side=LEFT)
        stoich_entry = Entry(stoich_frame, width=5, textvariable=self.get_stoichiometry)
        stoich_entry.pack(side=RIGHT)
